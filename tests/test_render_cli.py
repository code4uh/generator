...
from gridlayout.render.cli import main
...
def test_render_cli_passes_render_options_and_writes_html(monkeypatch, tmp_path: Path) -> None:
    ...
    monkeypatch.setattr("gridlayout.render.cli.render_layout_png_layers", _fake_render_layers)
    monkeypatch.setattr("gridlayout.render.cli.render_layout_png_stacked", _fake_render_stacked)
    monkeypatch.setattr("gridlayout.render.cli.write_layer_gallery_html", _fake_write_html)
